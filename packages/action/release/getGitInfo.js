...
function getGitInfo(overrideCommitName) {
  ...
  switch (context.eventName) {
    ...
    case 'pull_request_target':
      fallbackBranchName =
        ((_a = context.payload.pull_request) === null || _a === void 0 ? void 0 : _a.head.ref) ||
        UNKNOWN_GIT_INFO_DEFAULT;
      break;
    case 'release':
      fallbackBranchName = `Release-${
        ((_b = context.payload.release) === null || _b === void 0 ? void 0 : _b.tag_name) ||
        UNKNOWN_GIT_INFO_DEFAULT
      }`;
      break;
    case 'push':
