...
export const ALREADY_WRAPPED_TOKEN = '@sherlo/react-native-storybook/metro/withStorybook';
export const WITH_STORYBOOK_TOKEN = 'withStorybook(';

export const NEW_IMPORT_PACKAGE = '@sherlo/react-native-storybook/metro/withStorybook';
