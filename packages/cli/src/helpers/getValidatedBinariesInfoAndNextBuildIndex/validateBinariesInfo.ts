...
function validateBinariesInfo({
  ...
  console.log('[DEBUG] validateBinariesInfo - Validating:', {
    androidHasSdkVersion: binariesInfo.android?.sdkVersion ? true : false,
    iosHasSdkVersion: binariesInfo.ios?.sdkVersion ? true : false,
    command,
  });
...
function validateHasSherlo({ android, ios }: BinariesInfo) {
  ...
  console.log('[DEBUG] validateHasSherlo - Checking:', {
    android: android ? { path: 'provided', sdkVersion: android.sdkVersion } : 'not provided',
    ios: ios ? { path: 'provided', sdkVersion: ios.sdkVersion } : 'not provided',
    isAndroidMissingSherlo,
    isIosMissingSherlo,
  });

  if (isAndroidMissingSherlo || isIosMissingSherlo) {
    console.log('[DEBUG] validateHasSherlo - Error will be thrown for missing sherlo:', {
