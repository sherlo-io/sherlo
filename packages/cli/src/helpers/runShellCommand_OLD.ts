 ...
 */
function runShellCommand(options: Options & { encoding?: 'utf8' }): string;
function runShellCommand(options: Options & { encoding: 'buffer' }): Buffer;
function runShellCommand({ command, projectRoot, encoding = 'utf8' }: Options): string | Buffer {
